 ...
 * @brief JavaScript obfuscation configuration (Geruest::Obfuscation module).
 */

#ifndef GERUEST_OBFUSCATION_OBFUSCATIONSETTINGS_HPP
#define GERUEST_OBFUSCATION_OBFUSCATIONSETTINGS_HPP
...
#endif  // GERUEST_OBFUSCATION_OBFUSCATIONSETTINGS_HPP
